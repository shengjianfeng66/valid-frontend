...
export function InsightStepper({
    currentStep,
    onStepClick,
    translationNamespace = 'interview'
}: InsightStepperProps) {
            ...
            <Stepper value={currentStep} className="w-full">
                <StepperNav className="flex justify-between items-center">
                    ...
                    <StepperItem step={1} completed={currentStep > 1}>
                        ...
                        >
                            <StepperIndicator className={`w-10 h-10 text-sm font-medium ${currentStep > 1
                    ...
                    <StepperItem step={2} completed={currentStep > 2}>
                        ...
                        >
                            <StepperIndicator className={`w-10 h-10 text-sm font-medium ${currentStep > 2
                                    ? 'bg-primary text-white'
                                    : currentStep === 2
                                        ? 'bg-gray-200 text-gray-700 border-2 border-dashed border-primary'
                                        : 'bg-gray-200 text-gray-500'
                    ...
                    <StepperItem step={3} completed={currentStep > 3}>
                        ...
                        >
                            <StepperIndicator className={`w-10 h-10 text-sm font-medium ${currentStep > 3
                                    ? 'bg-primary text-white'
                                    : currentStep === 3
                                        ? 'bg-gray-200 text-gray-700 border-2 border-dashed border-primary'
                                        : 'bg-gray-200 text-gray-500'
